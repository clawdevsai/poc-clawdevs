...
# Executar uma vez após o Redis estar no ar. Ex.: kubectl exec -n ai-agents deploy/redis -- redis-cli < scripts/cluster/redis-streams-init.sh
# Ou: REDIS_HOST=localhost REDIS_PORT=6379 ./scripts/cluster/redis-streams-init.sh (com port-forward)
set -e
