#!/usr/bin/env python3
"""
ClawDevs — Transcrição M4A → MD
Converte arquivo de áudio M4A em texto e salva em arquivo .md.
Offline e sem custo de API para transcrição (faster-whisper ou openai-whisper). PT-BR.
Referência: docs/issues/009-transcricao-audio-m4a-to-md.md | docs/scripts/m4a_to_md.md
"""
...
def transcrever_audio(
    ...
    try:
        ...
        print("Processando áudio (faster-whisper)...")
        ...
        try:
            ...
            raise RuntimeError(
                "Nenhum backend de transcrição encontrado. "
...
def main():
    ...
    parser.add_argument(
        ...
        help="Dispositivo de computação (padrão: auto)",
    )
