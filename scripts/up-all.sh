...
echo "  Alertas Slack (opcional): ver docs/07-operations/orquestrador-automacao-cluster.md — kubectl create secret generic orchestrator-slack -n ai-agents --from-literal=SLACK_WEBHOOK_URL='...'"
