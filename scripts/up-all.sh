...
echo "  Alertas Slack (opcional): ver k8s/orchestrator/README.md — kubectl create secret generic orchestrator-slack -n ai-agents --from-literal=SLACK_WEBHOOK_URL='...'"
