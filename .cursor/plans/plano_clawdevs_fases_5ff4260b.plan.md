...
todos:
  ...
  - id: fase5-self-improvement-memoria
    ...
    status: completed
  - id: fase6-habilidades-transversais
    content: "Fase 6 — Habilidades transversais (060, 061): doc escopo docs/issues/fase6-escopo-e-ordem.md; 060 escrita humanizada (escrita-humanizada-checklist.md, diretriz no SOUL CEO); 061 expertise documentação (docs/agents-devs/README.md índice + fluxo identificar→buscar→ler→citar)."
    status: completed
  - id: fase7-ferramentas
    content: "Fase 7 — Ferramentas (070–075): doc escopo fase7-escopo-e-ordem.md; ferramentas-fase7-referencia.md; 070–073 docs existentes; 074 ollama.py + doc 31 (GPU Lock); 075 doc 33 OpenCode Controller."
    status: completed
isProject: false
---
