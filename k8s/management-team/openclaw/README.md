...
- **Acesso leitura/escrita:** Todos os agentes (CEO, PO, Developer, etc.) têm permissão para **ler e escrever** em qualquer pasta sob `/workspace`. O init garante que `/workspace/repos` exista com permissão 777 para repositórios compartilhados.
