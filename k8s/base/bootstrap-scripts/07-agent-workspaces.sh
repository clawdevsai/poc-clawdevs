...
cp /bootstrap/agent-config/ceo-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-ceo/skills/ceo_orchestration/SKILL.md"
...
cp /bootstrap/agent-config/po-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-po/skills/po_product_delivery/SKILL.md"
...
cp /bootstrap/agent-config/arquiteto-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-arquiteto/skills/arquiteto_engineering/SKILL.md"
...
cp /bootstrap/agent-config/dev_backend-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-dev_backend/skills/dev_backend_implementation/SKILL.md"
...
cp /bootstrap/agent-config/dev_frontend-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-dev_frontend/skills/dev_frontend_implementation/SKILL.md"
...
cp /bootstrap/agent-config/dev_mobile-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-dev_mobile/skills/dev_mobile_implementation/SKILL.md"
...
cp /bootstrap/agent-config/qa_engineer-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-qa_engineer/skills/qa_engineer_validation/SKILL.md"
...
cp /bootstrap/agent-config/devops_sre-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-devops_sre/skills/devops_sre_operations/SKILL.md"
...
cp /bootstrap/agent-config/security_engineer-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-security_engineer/skills/security_engineer_scan/SKILL.md"
...
cp /bootstrap/agent-config/ux_designer-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-ux_designer/skills/ux_designer_artifacts/SKILL.md"
...
cp /bootstrap/agent-config/dba_data_engineer-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-dba_data_engineer/skills/dba_data_engineer_schema/SKILL.md"
...
cp /bootstrap/agent-config/memory_curator-skill-SKILL.md "${OPENCLAW_STATE_DIR}/workspace-memory_curator/skills/memory_curator_promotion/SKILL.md"
