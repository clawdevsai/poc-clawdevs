...
- **011:** SOUL por escopo: [docs/soul/](soul/) é a fonte. **Management:** CEO em [workspace-ceo-configmap.yaml](../k8s/management-team/openclaw/workspace-ceo-configmap.yaml), PO em [k8s/management-team/soul/](../k8s/management-team/soul/) (soul-management-agents). **Development:** [k8s/development-team/soul/](../k8s/development-team/soul/) (soul-development-agents: devops, architect, developer, qa, cybersec, ux, dba). Gateway monta ambos em `/workspace/soul` via initContainer soul-merge.
