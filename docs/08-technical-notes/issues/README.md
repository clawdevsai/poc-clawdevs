...
| **3** | 030–039, **127** | Operações | Manual de primeiros socorros (030), prevenção (031), **disjuntor draft_rejected** (127). **Implementação operacional de 017:** **032** five strikes (2º Architect, 5º arbitragem nuvem); **033** aprovação por omissão cosmética (6 h, MEMORY.md); **034** loop de consenso pré-freio (QA + Architect, pilot); **035** QA auditor da dívida técnica; **036** digest diário e alertas imediatos. Autonomia nível 4, matriz CEO desempate. |
...
| 032 | 032-five-strikes-fallback-arbitragem.md | **Five strikes** (2º Architect, 5º arbitragem nuvem; PO + Architect retorno) |
| 033 | 033-aprovacao-omissao-cosmetica.md | **Aprovação por omissão cosmética** (timer 6 h, MEMORY.md; lógica → 5 strikes) |
| 034 | 034-loop-consenso-pre-freio-degradacao.md | **Loop de consenso** pré-freio (QA + Architect, pilot task; freio se falhar) |
| 035 | 035-qa-auditor-divida-tecnica.md | **QA auditor da dívida técnica** (testes exploratórios onde houve aprovação cosmética) |
| 036 | 036-digest-diario-alertas.md | **Digest diário** e alertas imediatos (segurança, $5/dia, freio de mão) |
...
**Total:** 64 issues para o projeto **team-devs-ai**.
