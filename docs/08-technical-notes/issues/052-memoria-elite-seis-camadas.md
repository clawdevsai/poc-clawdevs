...
- [x] Camada 4: MEMORY.md e memory/ (diários, destilação); instruções por momento da sessão em doc 28. **Ref:** [MEMORY.md](../agents-devs/MEMORY.md); templates em k8s/management-team/openclaw/workspace-ceo-configmap.yaml (MEMORY.md, working-buffer.md), doc 28 "Instruções por momento da sessão".
